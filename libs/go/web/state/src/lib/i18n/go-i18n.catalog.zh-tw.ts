...
const ZH_GAME = {
  ...
  'game.result.timeout': '{{winner}} 超時勝。{{loser}} 用時耗盡。',
...
const ZH_ROOM_SHARED = {
  ...
  'room.error.invalid_time_control': '請選擇官方圍棋時間制。',
  'room.error.time_control_not_supported': '正式圍棋時間制只適用於圍棋房間。',
  ...
  'room.notice.timeout': '{{player}} 超時負。',
...
const ZH_LOCAL_UI = {
  ...
  'time_control.system.fischer': 'Fischer 加秒',
  'time_control.system.canadian': '加拿大讀秒',
  'time_control.system.absolute': '包干',
  'time_control.summary.byo_yomi': '{{main}} + {{periods}} 次 {{period}} 讀秒',
  'time_control.summary.fischer': '{{main}} + 每手 {{increment}}',
  'time_control.summary.canadian': '{{main}} + {{stones}} 手 / {{period}}',
  'time_control.summary.absolute': '{{main}} 包干',
  ...
  'time_control.source': '來源：{{source}}',
  'time_control.not_available_gomoku': '五子棋房間不使用正式圍棋時間制。',
  ...
  'ui.game_board.point.empty': '{{point}}，空交叉點',
  'ui.game_board.point.stone': '{{point}}，{{player}}棋子',
  'ui.game_board.point.dead': '已標記為死子',
  'ui.game_board.point.last_move': '最後一手',
  'ui.game_board.point.winning': '勝利連線',
...
const ZH_HOSTED_UI = {
  ...
  'room.clock.main': '基本時間',
  'room.clock.byo_yomi_periods': '剩餘 {{count}} 次讀秒',
  'room.clock.fischer_increment': 'Fischer +{{increment}}',
  'room.clock.canadian_stones': '剩餘 {{count}} 手',
  'room.clock.absolute': '包干',
  ...
  'lobby.create_dialog.title': '建立房間',
  'lobby.create_dialog.description': '開房前先選擇這局要使用的模式與棋盤。',
  'lobby.create_dialog.mode': '模式',
  'lobby.create_dialog.board_size': '棋盤大小',
  'lobby.create_dialog.board_size_value': '{{size}} x {{size}}',
  'lobby.create_dialog.gomoku_board_size_fixed':
    '五子棋固定使用 {{size}} x {{size}} 棋盤。',
  'lobby.create_dialog.cancel': '取消',
  'lobby.create_dialog.confirm': '建立房間',
